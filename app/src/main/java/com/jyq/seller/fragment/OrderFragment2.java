...
import com.jyq.seller.adapter.OrderAdapter2;
...
public class OrderFragment2 extends BaseFragment implements IRequestListener, PullToRefreshBase.OnRefreshListener<RecyclerView>, SwipeRefreshLayout
        .OnRefreshListener
{
    ...
    private void finishOrder(String orderId)
    {
        ...
        Map<String, String> postMap = new HashMap<>();
        postMap.put("json", gson.toJson(valuePairs));
        DataRequest.instance().request(getActivity(), Urls.getOrederFinishUrl(), this, HttpRequest.POST, PICK_UP_REQUEST, postMap, new
                ResultHandler());
    }
